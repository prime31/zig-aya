...
pub const Draw = struct {
    ...
    pub fn bindTexture(self: *Draw, texture: Texture, slot: c_uint) void {
        self.batcher.mesh.bindImage(texture.img, slot);
    }

    /// unbinds a previously bound texture. All texture slots > 0 must be unbound manually!
    pub fn unbindTexture(self: *Draw, slot: c_uint) void {
        self.batcher.mesh.bindImage(0, slot);
    }

    // Drawing
    pub fn tex(self: *Draw, texture: Texture, x: f32, y: f32) void {
    ...
    pub fn texScale(self: *Draw, texture: Texture, x: f32, y: f32, scale: f32) void {
        self.quad.setFill(texture.width, texture.height);
    ...
    pub fn texScaleOrigin(self: *Draw, texture: Texture, x: f32, y: f32, scale: f32, ox: f32, oy: f32) void {
        self.quad.setFill(texture.width, texture.height);
    ...
    pub fn texViewport(self: *Draw, texture: Texture, viewport: RectI, transform: Mat32) void {

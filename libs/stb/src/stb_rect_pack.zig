...
pub const STBRP_HEURISTIC_Skyline_default = @intFromEnum(enum_unnamed_1.STBRP_HEURISTIC_Skyline_default);
// pub const STBRP_HEURISTIC_Skyline_BL_sortHeight = @enumToInt(enum_unnamed_1.STBRP_HEURISTIC_Skyline_BL_sortHeight);
pub const STBRP_HEURISTIC_Skyline_BF_sortHeight = @intFromEnum(enum_unnamed_1.STBRP_HEURISTIC_Skyline_BF_sortHeight);

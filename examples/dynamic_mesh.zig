...
fn init() void {
    ...
    mesh.verts[0] = .{ .pos = .{ .x = 0.5, .y = -0.5 }, .uv = .{ .x = 1, .y = 0 }, .col = 0x00FF0FFF };
    mesh.verts[1] = .{ .pos = .{ .x = -0.5, .y = -0.5 }, .uv = .{ .x = 0, .y = 0 }, .col = 0xFF00FFFF };
    mesh.verts[2] = .{ .pos = .{ .x = -0.5, .y = 0.5 }, .uv = .{ .x = 0, .y = 1 }, .col = 0x00FFFFFF };
    mesh.verts[3] = .{ .pos = .{ .x = 0.5, .y = 0.5 }, .uv = .{ .x = 1, .y = 1 }, .col = 0xFFFFFFFF };
...
fn update() void {
    const rx = aya.math.rand.range(f32, -0.02, 0.02);
    const ry = aya.math.rand.range(f32, -0.02, 0.02);

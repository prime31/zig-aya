...
fn render() !void {
    aya.debug.drawTextFmt("fps: {d:0.4}, dt: {d:0.4}", .{ aya.time.fps(), aya.time.rawDeltaTime() }, .{ .x = 770, .y = 20 }, Color.light_gray);
    ...
    // stencil write
    {
        ...
        aya.gfx.draw.rect(Vec2.init(50, 50), 200, 400, Color.lime);
    }
    ...
    // stencil read
    {
        ...
        aya.gfx.draw.rect(box_state.pos, 200, 400, Color.sky_blue);
